...
public partial class WMSBEFolder
{
    ...
    public override void Unpack(string srcPath, ISoulsFile? file, bool recursive)
    {
        ...
        if (Directory.Exists(OSPath.Combine(destDir, "Event")))
            Directory.Delete(OSPath.Combine(destDir, "Event"), true);
        Directory.CreateDirectory(OSPath.Combine(destDir, "Event"));
        if (Directory.Exists(OSPath.Combine(destDir, "Region")))
            Directory.Delete(OSPath.Combine(destDir, "Region"), true);
        Directory.CreateDirectory(OSPath.Combine(destDir, "Region"));
        if (Directory.Exists(OSPath.Combine(destDir, "Part")))
            Directory.Delete(OSPath.Combine(destDir, "Part"), true);
        Directory.CreateDirectory(OSPath.Combine(destDir, "Part"));
        if (Directory.Exists(OSPath.Combine(destDir, "Model")))
            Directory.Delete(OSPath.Combine(destDir, "Model"), true);
        Directory.CreateDirectory(OSPath.Combine(destDir, "Model"));
        if (Directory.Exists(OSPath.Combine(destDir, "Route")))
            Directory.Delete(OSPath.Combine(destDir, "Route"), true);
        Directory.CreateDirectory(OSPath.Combine(destDir, "Route"));
    ...
    private void UnpackEntries(XElement parentEl, List<MSBE.Entry> entries, string rootDir)
    {
        foreach (MSBE.Entry entry in entries)
        {
            ...
            string entryDir = OSPath.Combine(rootDir, entryDirName);
            ...
            switch (entry)
            {
                case MSBE.Event.Generator generator:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, generator.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.Mount mount:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mount.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.Navmesh navmesh:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, navmesh.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.ObjAct objAct:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, objAct.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.Other other:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, other.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.PatrolInfo patrolInfo:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, patrolInfo.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.PlatoonInfo platoonInfo:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, platoonInfo.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.PseudoMultiplayer pseudoMultiplayer:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, pseudoMultiplayer.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.RetryPoint retryPoint:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, retryPoint.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.SignPool signPool:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, signPool.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.Treasure treasure:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, treasure.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Event.AreaTeam areaTeam:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, areaTeam.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Model.Asset asset:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, asset.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Model.Collision collision:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, collision.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Model.Enemy enemy:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, enemy.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Model.MapPiece mapPiece:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mapPiece.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Model.Player player:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, player.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.Asset asset1:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, asset1.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.Collision collision1:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, collision1.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.ConnectCollision connectCollision:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, connectCollision.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.DummyAsset dummyAsset:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, dummyAsset.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.DummyEnemy dummyEnemy:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, dummyEnemy.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.Enemy enemy1:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, enemy1.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.MapPiece mapPiece1:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mapPiece1.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.Player player1:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, player1.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.AutoDrawGroupPoint autoDrawGroupPoint:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, autoDrawGroupPoint.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.BuddySummonPoint buddySummonPoint:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, buddySummonPoint.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.Connection connection:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, connection.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.DisableTumbleweed disableTumbleweed:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, disableTumbleweed.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.Dummy dummy:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, dummy.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.EnvironmentMapEffectBox environmentMapEffectBox:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, environmentMapEffectBox.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.EnvironmentMapOutput environmentMapOutput:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, environmentMapOutput.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.EnvironmentMapPoint environmentMapPoint:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, environmentMapPoint.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.FallPreventionRemoval fallPreventionRemoval:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, fallPreventionRemoval.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.FastTravelRestriction fastTravelRestriction:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, fastTravelRestriction.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.GroupDefeatReward groupDefeatReward:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, groupDefeatReward.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.Hitset hitset:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, hitset.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.HorseRideOverride horseRideOverride:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, horseRideOverride.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.LockedMountJump lockedMountJump:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, lockedMountJump.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.LockedMountJumpFall lockedMountJumpFall:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, lockedMountJumpFall.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.InvasionPoint invasionPoint:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, invasionPoint.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MapNameOverride mapNameOverride:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mapNameOverride.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MapPoint mapPoint:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mapPoint.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MapPointDiscoveryOverride mapPointDiscoveryOverride:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mapPointDiscoveryOverride.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MapPointParticipationOverride mapPointParticipationOverride:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mapPointParticipationOverride.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.Message message:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, message.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MountJump mountJump:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mountJump.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MountJumpFall mountJumpFall:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mountJumpFall.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MufflingBox mufflingBox:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mufflingBox.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MufflingPlane mufflingPlane:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mufflingPlane.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.MufflingPortal mufflingPortal:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mufflingPortal.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.NavmeshCutting navmeshCutting:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, navmeshCutting.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.Other other1:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, other1.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.PatrolRoute patrolRoute:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, patrolRoute.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.PatrolRoute22 patrolRoute22:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, patrolRoute22.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.PlayArea playArea:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, playArea.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.SFX sfx:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, sfx.GetType().Name, $"{fileName}.xml"));
                    WBUtil.XmlSerialize<MSBE.Region.SFX>(sfx, filePath);
                    el.SetAttributeValue("type", sfx.GetType().Name);
                    break;
                case MSBE.Region.Sound sound:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, sound.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.SoundRegion soundRegion:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, soundRegion.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.SpawnPoint spawnPoint:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, spawnPoint.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.WeatherCreateAssetPoint weatherCreateAssetPoint:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, weatherCreateAssetPoint.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.WeatherOverride weatherOverride:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, weatherOverride.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.WindArea windArea:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, windArea.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region.WindSFX windSfx:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, windSfx.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Route.MufflingBoxLink mufflingBoxLink:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mufflingBoxLink.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Route.MufflingPortalLink mufflingPortalLink:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, mufflingPortalLink.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Route.Other other2:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, other2.GetType().Name, $"{fileName}.xml"));
                    WBUtil.XmlSerialize<MSBE.Route.Other>(other2, filePath);
                    el.SetAttributeValue("type", other2.GetType().Name);
                    break;
                case MSBE.Event @event:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, @event.GetType().Name, $"{fileName}.xml"));
                    WBUtil.XmlSerialize<MSBE.Event>(@event, filePath);
                    el.SetAttributeValue("type", @event.GetType().Name);
                    break;
                case MSBE.Model model:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, model.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Part.EnemyBase enemyBase:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, enemyBase.GetType().Name, $"{fileName}.xml"));
                ...
                case MSBE.Region region:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, region.GetType().Name, $"{fileName}.xml"));
                    WBUtil.XmlSerialize<MSBE.Region>(region, filePath);
                    el.SetAttributeValue("type", region.GetType().Name);
                    break;
                case MSBE.Route route:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, route.GetType().Name, $"{fileName}.xml"));
                    WBUtil.XmlSerialize<MSBE.Route>(route, filePath);
                    el.SetAttributeValue("type", route.GetType().Name);
                    break;
                case MSBE.Part part:
                    filePath = WBUtil.NextAvailableFilename(OSPath.Combine(entryDir, part.GetType().Name, $"{fileName}.xml"));
            ...
            fileName = OSPath.GetFileNameWithoutExtension(filePath);
